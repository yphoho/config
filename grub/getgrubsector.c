...
enum ptt_type
{ ntfs = 0x7, ext = 0xf, logical = 0x5, ext4 = 0x83, swap = 0x82 };


BOOL ReadSectors(BYTE bDrive, _int64 dwStartSector, WORD wSectors,
                 LPBYTE lpSectBuff);
                 ...
                 LPBYTE lpSectBuff)
{
    ...
    HANDLE hDev =
        CreateFileA(devName, GENERIC_READ, FILE_SHARE_WRITE | FILE_SHARE_READ,
